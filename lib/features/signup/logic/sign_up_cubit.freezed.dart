...
mixin _$SignUpState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(SignupRequestBody body) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(SignupRequestBody body)? success,
...
abstract class _$$SuccessImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({SignupRequestBody body});
}
...
class _$SuccessImpl implements Success {
  const _$SuccessImpl({required this.body});
  ...
  @override
  String toString() {
    return 'SignUpState.success(body: $body)';
  }
...
abstract class Success implements SignUpState {
  const factory Success({required final SignupRequestBody body}) =
      _$SuccessImpl;

  SignupRequestBody get body;
